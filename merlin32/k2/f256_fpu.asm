...
FP_MATH_CTRL2 = $DE82     ; Not Used - Reserved
FP_MATH_CTRL3 = $DE83     ; Not Used - Reserved
;Read Only
FP_MATH_MULT_STAT = $DE84
...
FP_MATH_INPUT0_LL = $DE88
FP_MATH_INPUT0_LH = $DE89
FP_MATH_INPUT0_HL = $DE8A
FP_MATH_INPUT0_HH = $DE8B
;Write Input1 (either FP or Fixed (20.12)) - See MUX Setting
FP_MATH_INPUT1_LL = $DE8C
FP_MATH_INPUT1_LH = $DE8D
FP_MATH_INPUT1_HL = $DE8E
FP_MATH_INPUT1_HH = $DE8F
;Read Output
FP_MATH_OUTPUT_FP_LL = $DE88
FP_MATH_OUTPUT_FP_LH = $DE89
FP_MATH_OUTPUT_FP_HL = $DE8A
FP_MATH_OUTPUT_FP_HH = $DE8B
;Read FIXED Output (20.12) Format
FP_MATH_OUTPUT_FIXED_LL = $DE8C
FP_MATH_OUTPUT_FIXED_LH = $DE8D
FP_MATH_OUTPUT_FIXED_HL = $DE8E
FP_MATH_OUTPUT_FIXED_HH = $DE8F
